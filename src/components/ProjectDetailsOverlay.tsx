...
export function ProjectDetailsOverlay({
  ...
  }, [editingName, editingAlternatives, editingColor, editingImageUrl, project, onUpdate]);
  ...
  return (
    <>
      ...
      <div className="fixed inset-y-0 right-0 w-full max-w-2xl bg-white dark:bg-zinc-900 shadow-2xl z-50 flex flex-col">
