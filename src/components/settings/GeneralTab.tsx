...
export function GeneralTab({ general, people, projects, priorities, onUpdate }: GeneralTabProps) {
                      ...
                      <div className="absolute z-20 mt-1 w-64 bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-600 rounded shadow-lg">
                        ...
                        <div className="max-h-48 overflow-y-auto">
                          {people
                            .filter(
                              (p) =>
                                assignedSearch === "" || p.name.toLowerCase().includes(assignedSearch.toLowerCase()),
                            )
                            .slice(0, 10)
                            .map((p) => (
                              <button
